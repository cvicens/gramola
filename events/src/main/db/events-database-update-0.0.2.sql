...
DECLARE
    ...
    -- Declare constants
    C_VERSION CONSTANT TEXT := '0.0.2';
    C_SCRIPT_NAME CONSTANT TEXT := 'events-database-update-0.0.2.sql';
...
BEGIN
    ...
    ELSE
        ...
        LOOP
            UPDATE public.event SET start_date = event_row.date, end_date = event_row.date WHERE id = event_row.id;
        END LOOP;
    END IF;
