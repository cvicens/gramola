...
const DEFAULT_BACKEND_SERVICE = 'gateway';
...
function getConfig (fullUrl) {
    ...
    } else if (process.env.GW_SERVICE != null) {
        config.API_ENDPOINT = process.env.GW_SERVICE + '-' + process.env.OPENSHIFT_BUILD_NAMESPACE;
    }
